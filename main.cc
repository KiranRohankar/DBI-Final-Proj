...
int main() {
	...
	//Get the configuration from test.cat
	FILE *cat_fp = fopen("configuration", "r");
	...
	cout << "****************************************************************************"<<endl;
	cout << "******************** Welcome to YHSQL **************************************"<<endl;
	cout << "****It supports creating, load, query, drop operation***********************"<<endl;
	cout << "****customer, lineitem, nation, orders, part, partsupp, region, supplier****"<<endl;
	cout << "****************************************************************************"<<endl;
